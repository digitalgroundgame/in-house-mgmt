        ...
        <Grid.Col span={{ base: 12, md: 6 }}>
          <Paper withBorder p="lg" radius="md" h="100%">
            ...
            <Stack gap="md">
              {[
                {
                  icon: <IconBrandDiscord size={20} style={{ color: "#5865F2" }} />,
                  label: "Discord ID",
                  value: contact?.discord_id,
                },
                {
                  icon: <IconMail size={20} style={{ color: "var(--mantine-color-blue-6)" }} />,
                  label: "Email",
                  value: contact?.email,
                },
                {
                  icon: <IconPhone size={20} style={{ color: "var(--mantine-color-green-6)" }} />,
                  label: "Phone",
                  value: contact?.phone,
                },
                {
                  ...
                  label: "Added",
                  value: contact?.created_at ? formatDate(contact.created_at) : undefined,
                },
              ].flatMap((field, i, arr) => [
                <ContactField
                  key={field.label}
